...
-(void)setModel:(MessageModel *)model
{
    ...
    model.cellHeight=MAX(buttonMaxY, iconMaxY);
}
- (void)awakeFromNib {
    self.contentBtu.titleLabel.numberOfLines=0;
//    self.contentBtu.titleLabel.preferredMaxLayoutWidth=80;
//    self.contentBtu.contentEdgeInsets=UIEdgeInsetsMake(10, 20, 0, 15);
}
